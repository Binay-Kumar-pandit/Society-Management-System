...
import { UserPlus, User, Mail, Lock, Phone, Home, Calendar, Save, X } from 'lucide-react';
...
const AddMember: React.FC = () => {
  ...
  const onSubmit = async (data: MemberForm) => {
    setLoading(true);
    try {
      await axios.post('/api/auth/register', { ...data, role: 'member' });
      toast.success('Member added successfully! Login credentials sent to their email.');
      navigate('/members');
    } catch (error: any) {
        ...
        <div className="mb-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-sm font-medium text-blue-900">Member Registration</h3>
                <p className="text-sm text-blue-700 mt-1">
                  Add a new member to the society. Login credentials will be automatically generated and sent to their email address.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-emerald-600 hover:text-emerald-700 text-xs font-medium"
                >
                  Generate
                </button>
              </div>
